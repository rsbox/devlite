...
public class PlayerComposition {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.hintArrowType == 2) {
			class514.worldToScreen(Client.hintArrowSubX * 64 + (Client.hintArrowX - NpcOverrides.baseX * 64 << 7), (Client.hintArrowY - class101.baseY * 64 << 7) + Client.hintArrowSubY * 4096, Client.hintArrowHeight * 4);
