...
public class MidiPcmStream extends PcmStream {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) {
			int var4 = this.midiFile.division * this.field3427 * -727379968 / (PcmPlayer.field275 * 1019137945);
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) {
			int var2 = this.midiFile.division * this.field3427 * -727379968 / (PcmPlayer.field275 * 1019137945);
	...
	int method6021(MusicPatchNode var1) {
		...
		if (var2.field3405 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, 1.953125E-5D * (double)var1.field3509 * (double)var2.field3405) + 0.5D);
		}
	...
	boolean method6042(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3498 < 0 || var1.stream != null && !var1.stream.method1008()) {
			...
			if (var6.field3405 > 0) {
				if (var6.field3408 > 0) {
					var1.field3509 = var1.field3509 * -1887682560 + (int)(128.0D * Math.pow(2.0D, (double)var6.field3408 * var8) + 0.5D) * -1887682560;
				} else {
					var1.field3509 = var1.field3509 * -1887682560 + -1105199104;
				}
			}
