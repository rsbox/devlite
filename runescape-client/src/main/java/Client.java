...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class322 {
	...
	static {
		...
		field622 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
	...
	void method1270(String var1, String var2) throws IOException, JSONException {
		...
		var5.method9992("accountId", var2);
															...
															while (true) {
																...
																if (var48 == null) {
																	...
																	if (field482) {
																		...
																		if (!field748) {
																			var5 = ScriptFrame.field456 * 128 + 64;
																			var6 = class216.field2314 * 16384 + 64;
																		...
																		if (!field749) {
																			...
																			var6 = AbstractWorldMapData.field2575 * 16384 + 64;
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3357 == var1.serverPacket) {
					...
					field482 = false;
					field748 = true;
					ScriptFrame.field456 = var3.readUnsignedByte() * 16384;
					class216.field2314 = var3.readUnsignedByte() * 128;
					var21 = var3.readUnsignedShort();
					...
					var9 = ScriptFrame.field456 * 128 + 64;
					var23 = class216.field2314 * 16384 + 64;
					var62 = false;
					var82 = false;
					if (field661) {
				...
				if (ServerPacket.field3318 == var1.serverPacket) {
					...
					if (class1.field2 >= 100) {
						ViewportMouse.cameraX = ScriptFrame.field456 * 128 + 64;
						class36.cameraZ = class216.field2314 * 16384 + 64;
				...
				if (ServerPacket.field3261 == var1.serverPacket) {
					...
					field661 = var3.readBoolean();
					var6 = var3.readUnsignedByte();
					var7 = ScriptFrame.field456 * 128 + 64;
					var8 = class216.field2314 * 16384 + 64;
					boolean var61 = false;
					boolean var83 = false;
					if (field661) {
				...
				if (ServerPacket.field3317 == var1.serverPacket) {
					...
					AbstractWorldMapData.field2575 = var3.readUnsignedByte() * 128;
					class302.field3119 = var3.readUnsignedShort();
					var21 = var3.readUnsignedShort();
					var5 = var3.readUnsignedByte();
					var6 = Messages.field1400 * 16384 + 64;
					var7 = AbstractWorldMapData.field2575 * 16384 + 64;
				...
				if (ServerPacket.field3249 == var1.serverPacket) {
					...
					if (class134.field1581 >= 100) {
						...
						var5 = AbstractWorldMapData.field2575 * 16384 + 64;
