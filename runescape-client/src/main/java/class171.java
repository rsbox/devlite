		...
		if (var0 != null && var0.isVisible()) {
			...
			if (var0.overheadText != null && (!var8 || !var0.showPublicPlayerChat && (Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
				...
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
					...
					Client.overheadTextColors[Client.overheadTextCount] = var0.field1196;
					Client.overheadTextEffects[Client.overheadTextCount] = var0.field1197;
					Client.overheadTextCyclesRemaining[Client.overheadTextCount] = var0.overheadTextCyclesRemaining;
					Client.field597[Client.overheadTextCount] = var0.field1236;
			...
			int var22;
			int var23;
			if (!var0.healthBars.method7350()) {
				Canvas.method331(var0, var0.defaultHeight + 15);
				...
				for (HealthBar var10 = (HealthBar)var0.healthBars.last(); var10 != null; var10 = (HealthBar)var0.healthBars.previous()) {
					...
					if (var11 == null) {
						...
						if (var11.cycleOffset > var87) {
							var89 = var77.field1874 == 0 ? 0 : var77.field1874 * (var87 / var77.field1874);
			...
			if (var8 && var0.playerCycle == Client.cycle) {
				...
				if (Client.drawPlayerNames == 0) {
					...
					boolean var12 = (Client.drawPlayerNames & 4) != 0;
					boolean var13 = var12 || AbstractByteArrayCopier.method6822() && var92.isFriend();
					if (!var13) {
			...
			if (var8) {
				...
				NPC var91 = (NPC)var0;
				int[] var93 = var91.method2701();
				short[] var101 = var91.method2667();
				if (var101 != null && var93 != null) {
					for (int var95 = 0; var95 < var101.length; ++var95) {
						if (var101[var95] >= 0 && var93[var95] >= 0) {
							...
							SpritePixels var16 = (SpritePixels)Client.field779.method8022(var79);
							if (var16 == null) {
								SpritePixels[] var17 = VertexNormal.method5702(GrandExchangeOfferOwnWorldComparator.archive8, var93[var95], 0);
								if (var17 != null && var101[var95] < var17.length) {
									var16 = var17[var101[var95]];
									Client.field779.method8037(var79, var16);
								}
							}
			...
			for (int var100 = 0; var100 < 4; ++var100) {
				...
				if (var94 >= 0) {
					...
					var103 = class149.method3275(var0.hitSplatTypes[var100]);
					var96 = var103.field2060;
				...
				if (var15 >= 0) {
					var97 = class149.method3275(var15);
				...
				if (var81 - var96 <= Client.cycle) {
					if (var103 == null) {
						...
						Canvas.method331(var0, var0.defaultHeight / 2);
						if (Client.viewportTempX > -1) {
							boolean var104 = true;
							if (var100 == 1) {
							...
							int var63 = var103.field2065 - var62 * var103.field2065 / var103.field2060;
							int var64 = var62 * var103.field2066 / var103.field2060 + -var103.field2066;
							int var65 = var63 + (var2 + Client.viewportTempX - (var51 >> 1));
							int var66 = var64 + (var3 + Client.viewportTempY - 12);
							int var67 = var66;
							int var68 = var66 + var42;
							int var69 = var66 + var103.field2059 + 15;
							...
							int var74;
							if (var97 != null) {
								var72 = var66 + var97.field2059 + 15;
							...
							if (var73 >= 0 && var73 < 255) {
								...
								var83.drawAlpha(var45, var55 + var65, var69, var103.textColor, 0, var73);
								if (var97 != null) {
									if (var30 != null) {
