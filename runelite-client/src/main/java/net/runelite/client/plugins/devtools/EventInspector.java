...
public class EventInspector extends DevToolsFrame {
    ...
    private final JCheckBox projectiles = new JCheckBox("Projectiles", false);
    private final JCheckBox spotanims = new JCheckBox("Spotanims", false);
    private final JCheckBox sequences = new JCheckBox("Sequences", false);
    private final JCheckBox soundEffects = new JCheckBox("Sound Effects", false);
    private final JCheckBox areaSoundEffects = new JCheckBox("Area Sound Effects", false);
    private final JCheckBox say = new JCheckBox("Say", false);
    private final JCheckBox experience = new JCheckBox("Experience", false);
    private final JCheckBox stats = new JCheckBox("Stats", false);
    private final JCheckBox runEnergy = new JCheckBox("Run Energy", false);
    private final JCheckBox instances = new JCheckBox("Instances", false);
    private final JCheckBox messages = new JCheckBox("Messages", false);
    ...
    private final JCheckBox exactMove = new JCheckBox("Exact Move", false);
    private final JCheckBox tinting = new JCheckBox("Tinting", false);
    private final JCheckBox combatChange = new JCheckBox("Combat Level Change", false);
    private final JCheckBox nameChange = new JCheckBox("Name", false);
    private final JCheckBox combinedObjects = new JCheckBox("Combined Objects", false);
    private final JCheckBox transformations = new JCheckBox("Transformations", false);
    private final JCheckBox appearancesCheckbox = new JCheckBox("Appearances", false);
    private final JCheckBox ifEvents = new JCheckBox("Interface Events", false);
    private final JCheckBox inventoryChanges = new JCheckBox("Inventories", false);
    private final JCheckBox graphicsObjectChanges = new JCheckBox("Spotanim Specific", false);
    private final JCheckBox jingles = new JCheckBox("Jingles", false);
    private final JCheckBox hintArrows = new JCheckBox("Hint Arrows", false);
    private final JCheckBox camera = new JCheckBox("Camera", false);
    private final JCheckBox minimapState = new JCheckBox("Minimap State", false);
    ...
    private final JCheckBox mapObjectAnim = new JCheckBox("Map Object Anim", false);
    ...
    private final JCheckBox miscInterfacePackets = new JCheckBox("Misc. Interface Packets", false);
    private final JCheckBox playerMenuOptions = new JCheckBox("Player Menu Options", false);

    private final JCheckBox movement = new JCheckBox("Player Walk, Run and Crawl", false);
    private final JCheckBox teleportation = new JCheckBox("Player Teleportation", false);
    private final JCheckBox npcMovement = new JCheckBox("NPC Walk, Run, Crawl and Teleport", false);
    private final JCheckBox playerCount = new JCheckBox("Player Count", false);
    private final JCheckBox npcCount = new JCheckBox("NPC Count", false);
