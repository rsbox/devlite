...
public class class336 {
	...
	static final void method6302() {
		...
		if (MouseHandler.MouseHandler_currentButton == 4 && class19.mouseCam) {
			var0 = MouseHandler.MouseHandler_y - Client.field576;
			Client.camAngleDX = var0 * 2;
			Client.field576 = var0 != -1 && var0 != 1 ? (MouseHandler.MouseHandler_y + Client.field576) / 2 : MouseHandler.MouseHandler_y;
			...
			Client.field576 = MouseHandler.MouseHandler_y;
