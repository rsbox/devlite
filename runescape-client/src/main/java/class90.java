...
public enum class90 implements MouseWheel {
	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		while (true) {
			...
			var10 = Client.field622[var1.readBits(3)];
			if (var5) {
		...
		for (var21 = 0; var21 < Client.field637; ++var21) {
				...
				if ((var6 & 1) == 1) {
					...
					if ((var6 & 8) == 8) {
						...
						for (var23 = 0; var23 < var10; ++var23) {
							var16[var23] = (short)var1.method9303();
						}
					}
			...
			if ((var22 & 262144) != 0) {
				...
				var14.turnRightSequence = (var6 & 2) != 0 ? var1.method9303() : var14.definition.turnRightSequence;
				var14.walkSequence = (var6 & 4) != 0 ? var1.method9304() : var14.definition.walkSequence;
				var14.walkBackSequence = (var6 & 8) != 0 ? var1.method9303() : var14.definition.walkBackSequence;
				var14.walkLeftSequence = (var6 & 16) != 0 ? var1.method9304() : var14.definition.walkLeftSequence;
				var14.walkRightSequence = (var6 & 32) != 0 ? var1.method9303() : var14.definition.walkRightSequence;
				...
				var14.field1186 = (var6 & 256) != 0 ? var1.method9303() : var14.definition.field1954;
				var14.field1233 = (var6 & 512) != 0 ? var1.readUnsignedShort() : var14.definition.field1962;
				var14.field1188 = (var6 & 1024) != 0 ? var1.method9303() : var14.definition.field1961;
				var14.field1189 = (var6 & 2048) != 0 ? var1.readUnsignedShort() : var14.definition.field1941;
				var14.field1190 = (var6 & 4096) != 0 ? var1.method9303() : var14.definition.field1958;
				var14.field1239 = (var6 & 8192) != 0 ? var1.method9303() : var14.definition.field1945;
